...
function sendVerification($email, $verification)
{
    ...
    <body style='font-size: 1.25rem;padding: 20px; background-color: #FAFAFA;
    width: 75%; max-width: 1280px; min-width: 600px; margin-right: auto; margin-left: auto'>
        <div class='hero'>
            <table cellpadding='12' cellspacing='0' width='100%' style='border-collapse: collapse;margin: auto'>
            ...
            <tbody><tr><td style='padding: 50px; padding-bottom: 0; background-color: #fff'>
                ...
                </p><a href='http://localhost/s2106630/public_html/verify?email=$email&verification=$verification' style='background-color: #777;
                color: #fff; padding: 8px 24px; border-radius: 4px; border-style: solid; border-color: #777; font-size: 14px; text-decoration: none; cursor: pointer'>
