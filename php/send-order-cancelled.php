...
function sendOrderCancelled($email, $customerID, $collection, $trackingID)
{
    global $dbconnect;
    $pound                      = chr(163);
    ...
    "<head>
        ...
        <style>
            ...
            * { font-family: 'Varela', sans-serif; }
            ...
            a, a:link, a:visited{ text-decoration: none;color: #00788a; } a:hover { text-decoration: underline; }
            ...
            .retrieveOrder td{ min-width: 132px; } .ExternalClass{ width: 100%; }
            ...
            .retrieveOrder .quantity p{ color: #000; }
            .retrieveOrder p::after{ all: unset; }
        </style>
    </head>
        ...
        <div class='hero'><table cellpadding='12' cellspacing='0' width='100%' style='border-collapse: collapse;margin: auto'>
            ...
            <tbody><tr><td style='padding: 50px; padding-bottom: 0; background-color: #fff'><table width='100%'><tr><td style='text-align: center'>
                ...
                padding: 8px 24px; border-radius: 4px; border-style: solid; border-color: #777; font-size: 14px; text-decoration: none; cursor: pointer'>
                    ...
                    </div><br><a href='http://localhost/s2106630/public_html/view-order?trackingID=$trackingID' style='background-color: #777; color: #fff;
                    padding: 8px 24px; border-radius: 4px; border-style: solid; border-color: #777; font-size: 14px; text-decoration: none; cursor: pointer'>

                    See My Order
                </a><br><br><br><p style='font-size: 12px; margin-bottom: 30px; color: #202225; max-width: 60ch; margin-left: auto; margin-right: auto'>

                    You received this email because an account with this email cancelled an order on<br>Zed's Galaxy E-Commerce Store.
