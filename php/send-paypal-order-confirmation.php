...
function sendPaypalOrderConfirmation($email, $customerID, $collection, $trackingID)
{
    global $dbconnect;
    $pound                              = chr(163);
    ...
    "<head>
        ...
        <style>
            ...
            *{ font-family: 'Varela', sans-serif; } a, a:link, a:visited{ text-decoration: none;color: #00788a; }
            ...
            a:hover{ text-decoration: underline; } .retrieveOrder{ width: 100%;margin: 0 auto; }
            .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td{ line-height: 100%; }
            .ExternalClass{ width: 100%; } .retrieveOrder tbody tr:first-child td{ padding-top: 40px; }
            ...
            .retrieveOrder td{ min-width: 132px; } .retrieveOrder table img{ max-width: 100px; }
            .retrieveOrder thead td{ padding: 1.1rem 0.5rem;font-size: 0.9rem;text-align: center;
                color: #fff;max-width: 15rem;overflow: hidden;text-overflow: ellipsis; }
            .retrieveOrder thead td:nth-child(2){ text-align: left; } .retrieveOrder .quantity p{ color: #000; }
            .retrieveOrder thead td{ background: black;font-weight: 700;position: sticky !important;top: 0 !important;border: none;z-index: 3; }
            .retrieveOrder td:first-child{ max-width: 80px; } .retrieveOrder tr:last-child td{ border-bottom: 1px solid #000; }
            .retrieveOrder .imageContainer{ display: flex;align-items: center;justify-content: center;text-align: center;width: 100%; }
            .retrieveOrder tbody td{ text-align: center;background: #fff;padding: 10px;padding-bottom: 50px; }
            .retrieveOrder tbody td:nth-child(2){ text-align: left; } .retrieveOrder p::after{ all: unset; }
    ...
    <body style='font-size: 1.25rem;padding:20px; background-color: #FAFAFA; width: 75%; max-width: 1280px; min-width: 600px; margin-right: auto; margin-left: auto'>
        <div class='hero'><table cellpadding='12' cellspacing='0' width='100%' style='border-collapse: collapse;margin: auto'>
            ...
            <tbody><tr><td style='padding: 50px; padding-bottom: 0; background-color: #fff'><table width='100%'><tr><td style='text-align: center'>
                ...
                <a href='http://localhost/s2106630/public_html/view-order?trackingID=$trackingID' style='background-color: #777; color: #fff;
                padding: 8px 24px; border-radius: 4px; border-style: solid; border-color: #777; font-size: 14px; text-decoration: none; cursor: pointer'>
                    ...
                    <div class='retrieveOrder'><div class='tableResponsive'><table><thead><tr>
                            <td></td>
                            <td>Product:</td>
                            <td>Price:</td>
                            <td>Quantity:</td>
                            ...
                            $productTable
                    </tbody></table></div></div><h1 style='font-size: 30px; text-align: center; color: #202225; margin-top: 0;'><br>
                ...
                padding: 8px 24px; border-radius: 4px; border-style: solid; border-color: #777; font-size: 14px; text-decoration: none; cursor: pointer'>
                    ...
                    See My Order
                </a><br><br><br><p style='font-size: 12px; margin-bottom: 30px; color: #202225; max-width: 60ch; margin-left: auto; margin-right: auto'>

                    You received this email because an order was completed for an account with this email on<br>Zed's Galaxy E-Commerce Store.
